...
I received my PhD in Biostatistics from Harvard University, where I was advised by Dr. Xihong Lin and developed scalable methods for polygenic risk prediction from massive genomic datasets. Before that, I earned my bachelor’s degree in Operations Research and Financial Engineering from Princeton University, with a certificate in Statistics and Machine Learning. At Princeton, I completed my senior thesis with Dr. Jianqing Fan on high-dimensional variable selection with missing data.
